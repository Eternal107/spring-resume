...
<%@ attribute name="profile" required="true" type="net.study.resume.entity.Profile" %>
...
<div class="panel panel-primary">
	...
	<div class="list-group contacts">
		...
		<c:if test="${profile.contacts.telegram != null }">
		<a href="${profile.contacts.telegram}" class="list-group-item" target="_blank"><i class="fa fa-telegram"></i> ${profile.contacts.telegram}</a>
		</c:if>
